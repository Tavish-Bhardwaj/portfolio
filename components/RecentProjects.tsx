...
//                   <Image src="/bg.png" alt="bg-img" fill={true} objectFit="cover" />
//                 </div>
...
// //               <div className="relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden sm:h-[40] h-[30-vh] mb-10">
// //                 <div className="relative w-full h-full overflow-hidden lg:rounded-3xl bg-[#13162d]">
// //                   <Image src="/bg.png" alt="bg-img" fill={true} style={{ objectFit: 'cover' }} />
// //                 </div>
// //                 <Image src={img} alt={title} width={500} height={300} className="z-10 absolute bottom-0" />
// //               </div>
// //               <h1 className="font-bold lg:text-2xl md:text-xl text-base line-clamp-1">
    ...
    <div className="py-20" id="projects">
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10">
        {projects.map(({ id, title, des, img, iconLists, link }, projIndex) => (
          <div key={id} className='sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] flex items-center justify-center sm:w-[570px] w-[80vw]'>
            <PinContainer title={title} href={link}>
              <div className="relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden mb-10" style={{ height: '30vh' }}>
                <div className="relative w-full h-full overflow-hidden lg:rounded-3xl bg-[#13162d]">
                  <Image 
                    src="/bg.png" 
                    alt="bg-img" 
                ...
                <Image 
                  ...
                  height={300} 
                  className="z-10 absolute bottom-0" 
                  style={{ width: '100%', height: 'auto' }} // Ensure aspect ratio is maintained
                />
              </div>
              <h1 className="font-bold lg:text-2xl md:text-xl text-base line-clamp-1">
                {title}
